...
<div class="bg-white">
    ...
    <div class="container p-5">
        ...
        <div class=" p-5">
            <div class="w-75 mx-auto answer bg-light p-5">
               <h6 class="font-weight-bold mb-3">Thank you for your interest in becoming a NI-Q Donor. But Due to your answers you have been waitlisted for 14 days</h6>
